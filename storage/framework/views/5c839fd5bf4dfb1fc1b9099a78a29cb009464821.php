<div class="row">
    <div class="col-md-6 col-sm-6">
        <button data-target="#form-dialog-sub" data-toggle="modal" class="btn pmd-ripple-effect btn-primary pmd-z-depth pmd-ripple-effect " type="button">Add District</button>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header bordered">
                        ...
                        <h2 class="pmd-card-title-text">Add District</h2>
                    </div>
                    <div class="modal-body">

                            <?php echo e(Form::open(['url'=> 'save-district', 'method' => 'post', 'class' => 'form-horizontal' ])); ?>
                                    ...
                                    <div class="pmd-card pmd-z-depth pmd-card-custom-form">
                                        <div class="pmd-card-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="regular1" class="form-control" name="district_name">
                                            </div>
                                            <?php if($errors->has('district_name')): ?>
                                                <span class="invalid-feedback" role="alert">
                                        <strong style="color: red"><?php echo e($errors->first('district_name')); ?></strong>
                                    </span>
                                        <?php endif; ?>
