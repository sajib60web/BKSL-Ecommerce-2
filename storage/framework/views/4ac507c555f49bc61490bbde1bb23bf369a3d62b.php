            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <?php echo e(Form::open(['url'=> '/save-product', 'method' => 'post', 'class' => 'form-horizontal', 'enctype' => 'multipart/form-data' ])); ?>
                                ...
                                <div class="col-md-12">
                                    <div class="pmd-card pmd-z-depth pmd-card-custom-form">
                                        ...
                                        <!-- Textarea -->
                                            <div class="form-group">
                                                <div class="col-md-12 col-sm-12">
                                                    <div class="component-box">
                                                        ...
                                                        <?php endif; ?>
                                                        <?php if($errors->has('hot_product')): ?>
                                                            <span class="invalid-feedback" role="alert">
                                                            <strong style="color: red"><?php echo e($errors->first('hot_product')); ?></strong>
                                                             </span>
                                                        <?php endif; ?>
                                                        <?php if($errors->has('top_rated')): ?>
                                                            <span class="invalid-feedback" role="alert">
                                                            <strong style="color: red"><?php echo e($errors->first('top_rated')); ?></strong>
                                                             </span>
                                                        <?php endif; ?>
                                                            ...
                                                            <div class="pmd-card">
                                                                <div class="pmd-card-body">
                                                                    ...
                                                                    <div class="tab-content">
                                                                        <?php echo $__env->make('backEnd.includes.product.include.product_eng', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                                                                        <?php echo $__env->make('backEnd.includes.product.include.product_ban', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                                                                        <?php echo $__env->make('backEnd.includes.product.include.product_hin', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                                                                    </div>
                                                                </div>
                                                            </div>
                                            ...
                                            <div id="price">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-12">
                                                        ...
                                                        <?php if($errors->has('price_first_number')): ?>
                                                            <span class="invalid-feedback" role="alert">
                                                                <strong style="color: red"><?php echo e($errors->first('price_first_number')); ?></strong>
                                                            </span>
                                                        <?php endif; ?>
                                                        <div class="col-md-2">
                                                            <input type="number" min="2" id="regular1" class="form-control" name="price_last_number[]">
                                                        </div>
                                                        <?php if($errors->has('price_last_number')): ?>
                                                            <span class="invalid-feedback" role="alert">
                                                                <strong style="color: red"><?php echo e($errors->first('price_last_number')); ?></strong>
                                                            </span>
                                                        <?php endif; ?>
                                                        <div class="col-md-6">
                                                            <input type="number" min="1" id="regular1" class="form-control" name="first_to_last_number_price[]">
                                                        </div>
                                                        <?php if($errors->has('first_to_last_number_price')): ?>
                                                            <span class="invalid-feedback" role="alert">
                                                                <strong style="color: red"><?php echo e($errors->first('first_to_last_number_price')); ?></strong>
                                                            </span>
                                                        <?php endif; ?>
                                            ...
                                            <?php if($errors->has('prodcut_image')): ?>
                                                <span class="invalid-feedback" role="alert">
                                                    <strong style="color: red"><?php echo e($errors->first('product_image')); ?></strong>
                                                </span>
                                            <?php endif; ?>
