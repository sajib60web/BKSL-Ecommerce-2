            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <?php echo e(Form::open(['url'=> 'update-country', 'name' => 'editeSubCat', 'method' => 'post', 'class' => 'form-horizontal' ])); ?>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="pmd-card pmd-z-depth pmd-card-custom-form">
                                        ...
                                        <strong style="color: red"><?php echo e($errors->first('country_name')); ?></strong>
                                    </span>
                                            <?php endif; ?>
                                        ...
                                        <!-- Textarea -->
                                            ...
                                            <?php if($errors->has('country_description')): ?>
                                                <span class="invalid-feedback" role="alert">
                                        <strong style="color: red"><?php echo e($errors->first('country_description')); ?></strong>
                                    </span>
                                            <?php endif; ?>
                                            <div class="form-group">
