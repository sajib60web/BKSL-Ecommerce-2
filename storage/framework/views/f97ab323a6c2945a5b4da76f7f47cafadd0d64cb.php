<?php $__env->startSection('title', 'Shopper Edit Product'); ?>
        ...
        <div class="row mt-5" style="border: 1px solid gainsboro; padding-top: 30px; padding-bottom: 50px">
            <div class="col-lg-12">
                ...
                <div class="col-lg-8 offset-lg-1" style="margin: 0 auto; ">
                    ...
                    <form method="POST" action="<?php echo e(URL::to('/shopper-update-product')); ?>" name="editShopper" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
                                    ...
                                    <div class="pmd-card pmd-z-depth pmd-card-custom-form">
                                        <div class="pmd-card-body">
                                                    ...
                                                    <div class="component-box">
                                                                    ...
                                                                    <div class="tab-content">
                                                                        <div role="tablist" class="tab-pane active" id="bootstrap-home">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input type="text" id="product_name_eng" required="" class="form-control" value="<?php echo e($product->product_name_eng); ?>" name="product_name_eng">
                                                                            ...
                                                                            <div class="form-group">
                                                                                ...
                                                                                <textarea  required="" name="product_short_description_eng"  class="form-control">
                                                                                    <?php echo e($product->prodcut_long_description_eng); ?>
                                                        ...
                                                        <div class="form-group">
                                                            <div class="checkbox">
                                                                ...
                                                                <label class="pmd-checkbox pmd-checkbox-ripple-effect">
                                                                    <input name="offer" value="<?php echo e($product->offer); ?>" id="offer" type="checkbox" class="pm-ini"><span class="pmd-checkbox-label">&nbsp;</span>
                                                                    <i class="input-helper"></i>
                                                                    Offer
                                                                </label>
                                                            </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="number" required="" class="form-control" value="<?php echo e($product->product_qty); ?>" name="product_qty">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-12">
                                                    <input type="number" min="1" id="old_Price" class="form-control" name="old_Price" value="<?php echo e($product->old_Price); ?>">
                                                </div>
                                                <label class="control-label">Sale Price</label>
                                                <div class="col-md-12">
                                                    <input type="number" min="1" id="sale_Price" class="form-control" name="sale_Price" value="<?php echo e($product->sale_Price); ?>">
                                                </div>
                                            </div>
                                            ...
                                            <div class="tab-content">
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-6">
                                                                    ...
                                                                    <div class="form-group">
                                                                        <input type="number" class="form-control" name="main_qty" value="<?php echo e($product->main_qty); ?>" placeholder="Enter Your Main Product QTY">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                ...
                                                <div role="tablist" class="tab-pane" id="bootstrap-downlable">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="download_link" value="<?php echo e($product->download_link); ?>" placeholder="Enter Download link">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <label class="control-label">Others</label>
                                                <input type="text" class="form-control"  name="others" value="<?php echo e($product->others); ?>">
                                            </div>
...
<script type="text/javascript">
    document.forms['editShopper'].elements['main_category_id'].value =<?php echo e($product->main_category_id); ?>;
    document.forms['editShopper'].elements['sub_category_id'].value =<?php echo e($product->sub_category_id); ?>;
    document.forms['editShopper'].elements['product_brand'].value =<?php echo e($product->product_brand); ?>;
    document.forms['editShopper'].elements['offer'].value =<?php echo e($product->offer); ?>;
    document.forms['editShopper'].elements['stock_status'].value = <?php echo e($product->stock_status); ?>
