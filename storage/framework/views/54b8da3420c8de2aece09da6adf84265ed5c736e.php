        ...
        <div class="row">
            ...
            <div class="col-sm-6" style="height: 500px;">
                ...
                <div class="alert alert-success text-center">
                    <p>Dear <strong><?php echo e(Session::get('customer_name')); ?>,</strong> Please Fill Your Billing Information</p>
                </div>
                <br/>
                <?php echo e(Form::open(['url'=> '/customer-bill-save', 'method' => 'post', 'class' => 'form-horizontal' ])); ?>

                <?php echo csrf_field(); ?>
                    <div class="form-group">
                        <input type="text" style="height: 45px;" name="customer_name"  value="<?php echo e($customer->customer_name); ?>"  class="form-control" placeholder="Enter your name" required="required" data-error="Name is required.">
                    ...
                    <div class="form-group">
                        <input type="number" style="height: 45px;" name="customer_phone_number" value="<?php echo e($customer->customer_phone_number); ?>"  class="form-control" placeholder="Enter your phone number " required="required" data-error="Name is required.">
                    </div>
                    <div class="form-group">
                        <input type="email" style="height: 45px;" name="customer_email" value="<?php echo e($customer->customer_email); ?>"  class="form-control" placeholder="Enter your email" required="required" data-error="Name is required.">
                    </div>
                    <div class="form-group">
