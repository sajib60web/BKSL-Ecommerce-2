<aside id="basicSidebar" class="pmd-sidebar  sidebar-default pmd-sidebar-slide-push pmd-sidebar-left pmd-sidebar-open bg-fill-darkblue sidebar-with-icons" role="navigation">
    <ul class="nav pmd-sidebar-nav">
        ...
        <li class="dropdown pmd-dropdown pmd-user-info visible-xs visible-md visible-sm visible-lg">
            <a aria-expanded="false" data-toggle="dropdown" class="btn-user dropdown-toggle media" data-sidebar="true" aria-expandedhref="javascript:void(0);">
                <div class="media-left">
                    <img src="<?php echo e(asset('backEnd/themes/')); ?>/images/user-icon.png" alt="New User">
                </div>
                <div class="media-body media-middle"><?php echo e(Session::get('admin_name')); ?></div>
                <div class="media-right media-middle"><i class="dic-more-vert dic"></i></div>
            </a>
            <ul class="dropdown-menu">
                <li><a onclick="return confirm('Are you Sure?? \n You Want To Logout From This Applicaion')" href="<?php echo e(URL::to('/logout')); ?>">Logout</a></li>
            </ul>
        </li><!-- End user info -->

        <li>
            <a class="pmd-ripple-effect" href="<?php echo e(route('/dash-board')); ?>">
        ...
        <li class="dropdown pmd-dropdown">
            ...
            <ul class="dropdown-menu">
                <li><a href="<?php echo e(URL::to('/slider')); ?>">Slider</a></li>
                <li><a href="<?php echo e(URL::to('/logo')); ?>">Logo</a></li>
                <li><a href="<?php echo e(URL::to('/info')); ?>">Info</a></li>
                <li><a href="<?php echo e(URL::to('/dynamic-page')); ?>">Dynamic Pages</a></li>
                <!-- <li><a href="<?php echo e(URL::to('/event-image')); ?>">Event Image</a></li> -->
                <!-- <li><a href="<?php echo e(URL::to('/district')); ?>">District</a></li> -->
                <!-- <li><a href="<?php echo e(URL::to('/sub-district')); ?>">Sub District</a></li> -->
            </ul>
        </li>
    <?php endif; ?>
    <li>
        <a class="pmd-ripple-effect" href="<?php echo e(URL::to('/product')); ?>">
    ...
    <li class="dropdown pmd-dropdown">
        ...
        <ul class="dropdown-menu">
            ...
            <li><a href="<?php echo e(URL::to('/delevery-order')); ?>">Delivered List</a></li>
            <?php if(Session::get('admin_role') == 2): ?>
            <li><a href="<?php echo e(URL::to('/shopper-order-list')); ?>">Shopper Order List</a></li>
            <li><a href="<?php echo e(URL::to('/shopper-delevered-list')); ?>">Shopper Delevered List</a></li>
            <?php endif; ?>
    ...
    <li class="dropdown pmd-dropdown">
        ...
        <ul class="dropdown-menu">
            <li><a href="<?php echo e(URL::to('/manage-frame')); ?>">manage Frame</a></li>
            <li><a href="<?php echo e(URL::to('/fb-cover')); ?>">FB Cover</a></li>
            <li><a href="<?php echo e(URL::to('/delevery-order')); ?>">FB Product</a></li>
        </ul>
    </li>
    <?php if(Session::get('admin_role') == 2): ?>
    <li>
        <a class="pmd-ripple-effect" href="<?php echo e(URL::to('/customer-list')); ?>">
            <i class="media-left media-middle">
                <svg version="1.1" id="Layer_1" x="0px" y="0px" width="15.3px" height="18px" viewBox="289.99 337.535 15.3 18" enable-background="new 289.99 337.535 15.3 18" xml:space="preserve">
                    <g>
                        <g>
    ...
    <li>
        <a class="pmd-ripple-effect" href="<?php echo e(URL::to('/register')); ?>">
            <i class="media-left media-middle">
    ...
    <li class="dropdown pmd-dropdown">
        ...
        <ul class="dropdown-menu">
            <li><a href="<?php echo e(URL::to('/main-categories')); ?>">Main Categories</a></li>
            <li><a href="<?php echo e(URL::to('/sub-categories')); ?>">Sub Categories</a></li>

        </ul>
    </li>
    <li>
        <a class="pmd-ripple-effect" href="<?php echo e(URL::to('/show-brand')); ?>">
            <i class="media-left media-middle">
    ...
    <li class="dropdown pmd-dropdown">
        ...
        <ul class="dropdown-menu">
            <li><a href="<?php echo e(URL::to('/country')); ?>">Country</a></li>
            <li><a href="<?php echo e(URL::to('/division')); ?>">Division</a></li>
    ...
    <li>
        <a class="pmd-ripple-effect" href="<?php echo e(URL::to('/member-cart')); ?>">
            <i class="media-left media-middle">
                <svg version="1.1" id="Layer_1" x="0px" y="0px" width="15.3px" height="18px" viewBox="289.99 337.535 15.3 18" enable-background="new 289.99 337.535 15.3 18" xml:space="preserve">
                    <g>
                        <g>
    ...
    <li>
        <a class="pmd-ripple-effect" href="<?php echo e(URL::to('/extra-income')); ?>">
            <i class="media-left media-middle">
                <svg version="1.1" id="Layer_1" x="0px" y="0px" width="15.3px" height="18px" viewBox="289.99 337.535 15.3 18" enable-background="new 289.99 337.535 15.3 18" xml:space="preserve">
                    <g>
                        <g>
    ...
    <li>
        <a class="pmd-ripple-effect" href="<?php echo e(URL::to('/expense')); ?>">
            <i class="media-left media-middle">
                <svg version="1.1" id="Layer_1" x="0px" y="0px" width="15.3px" height="18px" viewBox="289.99 337.535 15.3 18" enable-background="new 289.99 337.535 15.3 18" xml:space="preserve">
                    <g>
                        <g>
    ...
    <?php endif; ?>
        <li>
            <a class="pmd-ripple-effect" href="<?php echo e(URL::to('/logOut')); ?>">
                <i class="media-left media-middle">
                    <svg version="1.1" id="Layer_1" x="0px" y="0px" width="15.3px" height="18px" viewBox="289.99 337.535 15.3 18" enable-background="new 289.99 337.535 15.3 18" xml:space="preserve">
                    <g>
                        <g>
