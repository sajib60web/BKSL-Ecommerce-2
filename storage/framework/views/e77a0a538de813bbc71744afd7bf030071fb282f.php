                    ...
                    <div class="pmd-card pmd-z-depth">
						...
						<span class="service-icon img-circle bg-fill-orange">
                            ...
                            <div class="media-body media-middle">
                                <h2 class="pmd-card-title-text typo-fill-secondary">Shopper Dashboard<span class="grow-up"><img src="<?php echo e(asset('backEnd/themes/')); ?>/images/grow-up-arrow.png" alt="grow-up"></span></h2>
                            </div>
                        ...
                        <div class="pmd-card-body">
                            <div class="container" style="margin: auto">
                                <div class="row">
                                    ...
                                    <div class="col-md-7"><?php echo e($url); ?></div>
                                </div>
