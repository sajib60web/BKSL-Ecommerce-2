...
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="<?php echo e(asset('backEnd/themes/')); ?>/images/favicon.ico">
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('backEnd/assets/')); ?>/css/propeller.min.css">
    <!-- /build -->

    <!-- Propeller date time picker css-->
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('backEnd/components/')); ?>/datetimepicker/css/bootstrap-datetimepicker.css" />
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('backEnd/components/')); ?>/datetimepicker/css/pmd-datetimepicker.css" />

    <!-- Propeller theme css-->
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('backEnd/themes/')); ?>/css/propeller-theme.css" />

    <!-- Propeller admin theme css-->
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('backEnd/themes/')); ?>/css/propeller-admin.css">
    <link rel="stylesheet" href="//code.jquery.com/ui/1.12.1/themes/base/jquery-ui.css">
    <link rel="stylesheet" href="<?php echo e(asset('backEnd/stepper')); ?>/dist/css/bs-stepper.min.css">
</head>
...
<!-- Left sidebar -->
<?php echo $__env->make('backEnd.includes.slider', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<!-- End Left sidebar -->
<!-- Sidebar Ends -->
...
<!-- Scripts Starts -->
<script src="<?php echo e(asset('backEnd/assets/')); ?>/js/jquery-1.12.2.min.js"></script>

<script src="https://code.jquery.com/ui/1.12.1/jquery-ui.js"></script>
<script src="https://cdn.jsdelivr.net/npm/bs-breakpoints/dist/bs-breakpoints.min.js"></script>
<script src="<?php echo e(asset('backEnd/stepper')); ?>/dist/js/bs-stepper.min.js"></script>
<script src="<?php echo e(asset('backEnd/stepper')); ?>/js/main.js"></script>
...
<script src="<?php echo e(asset('backEnd/assets/')); ?>/js/propeller.min.js"></script>
...
<!--circle chart-->
<script src="<?php echo e(asset('backEnd/themes/')); ?>/js/circles.min.js"></script>
<script>
...
<script src="<?php echo e(asset('backEnd/themes/')); ?>/js/highcharts.js"></script>
<script src="<?php echo e(asset('backEnd/themes/')); ?>/js/highcharts-more.js"></script>
...
<script type="text/javascript" language="javascript" src="<?php echo e(asset('backEnd/components/')); ?>/datetimepicker/js/moment-with-locales.js"></script>
<script type="text/javascript" language="javascript" src="<?php echo e(asset('backEnd/components/')); ?>/datetimepicker/js/bootstrap-datetimepicker.js"></script>
<script>
