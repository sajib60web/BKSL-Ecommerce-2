<?php $__env->startSection('title', 'Shopper Create Product'); ?>
        ...
        <div class="row" style="border: 1px solid gainsboro; padding-top: 30px; padding-bottom: 50px">
            <div class="col-lg-12">
                ...
                <div class="col-lg-8 offset-lg-1" style="margin: 0 auto; ">
                    ...
                    <form method="POST" action="<?php echo e(route('/shopper-save-product')); ?>" name="editShopper" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
...
<script>
    $(document).ready(function(){
        ...
        $(document).on('change','#product_cat_up', function () {
            ...
            $.ajax({
                type:'get',
                url: '<?php echo route("/shoper-subcat-categories"); ?>',
                datatype: 'html',
                data:{'id':cat_id},
