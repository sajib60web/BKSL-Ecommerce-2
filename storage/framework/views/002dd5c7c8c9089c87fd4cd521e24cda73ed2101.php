...
<div class="container" style="border: 1px solid #CCCCCC;">
    <div class="col-sm-12"><br/>
        <div style="float: right;">
            <div class="cart_count" style="float: right; font-size: 20px; border: 0px solid #000000; width: 100px;"><a href="<?php echo url('/afflite-cart-page'); ?>"> <b class="text-primary" style="float: right;">Cart : <?php echo e(Cart::getTotalQuantity()); ?></b></a><br/>
        ...
        <?php $__currentLoopData = $cartContents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cartContent): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="row">
                ...
                <div class="col-sm-4">
                    <div class="form-group">
                        <h6 class="font"><?php echo e(str_limit($cartContent->name)); ?></h6>
                        ...
                        <h6 class="font" style="text-align: left; color: #0d82d3">Price : ৳ <?php echo e($cartContent->price); ?></h6>
                        <h6 class="font" style="text-align: left;">Total : ৳ <?php echo e($cartContent->quantity*$cartContent->price); ?></h6>
    ...
    <div class="col-sm-12">
        <div class="row" style="text-align: center; margin: auto;">
            ...
            <div class="col-sm-2"><h4>:</h4></div>
            <div class="col-5" id="subTotal"><h4><b>৳ <?php echo e($subTotal); ?></b></h4></div>
        </div>
        <hr/>
    </div>
    <div class="col-sm-12">
        <div class="row" style="text-align: center; margin: auto;">
            ...
            <div class="col-sm-2"><h4>:</h4></div>
            <div class="col-5" ><h4><b>৳ <span id="subTotalwithDis"><?php echo e($subTotal); ?></span></b></h4></div>
        </div>
        <hr/>
    </div>
    <div class="col-sm-12">
        <div class="row" style="text-align: center; margin: auto;">
            <div class="col-sm-5"><a href="<?php echo e(URL::to('/index')); ?>" class="btn btn-primary btn-block" style="font-weight: bold;">More Shopping....</a></div>
            <div class="col-sm-2"><h4></h4></div>
            <?php if(Session::get('customer_id') && Session::get('billing_id') && Session::get('shipping_id')): ?>
            <div class="col-sm-5"><a href="<?php echo e(URL::to('/payment-info')); ?>" class="btn btn-success btn-block" style="font-weight: bold;">Check Out</a></div>
            <?php elseif(Session::get('customer_id') && Session('billing_id')): ?>
                <div class="col-sm-5"><a href="<?php echo e(URL::to('/register-affiliate-customer')); ?>" class="btn btn-success btn-block" style="font-weight: bold; font-size: 20px;">Check Out</a></div>
            <?php elseif(Session::get('customer_id')): ?>
                <div class="col-sm-5"><a href="<?php echo e(URL::to('/billing-page')); ?>" class="btn btn-success btn-block">Check Out</a></div>
            <?php else: ?>
                <div class="col-sm-5"><a href="<?php echo e(URL::to('/register-affiliate-customer')); ?>" class="btn btn-success btn-block">Check Out</a></div>
            <?php endif; ?>
        </div>
        <hr/>
    </div>
...
<script type="text/javascript">
    ...
    function updateCart(id,qty) {
        ...
        $.ajax({
            type:'get',
            url: "<?php echo e(route('/update-cart-blur')); ?>",
            datatype: 'html',
            data:{
                'id':id,
                'qty':qty
    ...
    $('#membership_id').blur(function () {
        ...
        $.ajax({
            type:'get',
            url: "<?php echo e(route('/memberCart-discount')); ?>",
            datatype: 'html',
            data:{'id':id},
            success:function (data) {
