            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <?php echo e(Form::open(['url'=> '/save-slider', 'method' => 'post', 'class' => 'form-horizontal', 'enctype' => 'multipart/form-data' ])); ?>
                                        ...
                                        <div class="pmd-card-body">
                                            ...
                                            <?php if($errors->has('slider_image')): ?>
                                                <span class="invalid-feedback" role="alert">
                                                    <strong style="color: red"><?php echo e($errors->first('slider_image')); ?></strong>
                                                </span>
                                            <?php endif; ?>
                                            <div class="form-group">
