        ...
        <div class="table-responsive pmd-card pmd-z-depth">
            <table class="table table-mc-red pmd-table">
                ...
                <tbody id="product_table">
                    <?php $__currentLoopData = $farmes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $farme): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        <td  style="text-align: center" data-title="Total"><img style="height: 100px; width: 100px"  src="<?php echo e(asset($farme->farme_image)); ?>" ></td>
                        <td  style="text-align: center"data-title="Status"><span class="status-btn blue-bg"><?php echo e($farme->status == 1 ? 'Publishe' : 'Unpublished'); ?></span></td>
                        <td style="text-align: center; width: auto" class="pmd-table-row-action">
                            <?php if(Session::get('admin_role') == 1): ?>
                                <?php if($farme->status == 0): ?>
                                <a href="<?php echo e(URL::to('/publish-farme/'.$farme->id)); ?>" class="btn pmd-btn-fab pmd-btn-flat pmd-ripple-effect btn-default btn-sm">
                                    <i class="material-icons md-dark pmd-sm">thumb_up</i>
                                </a>
                                <?php else: ?>
                                <a href="<?php echo e(URL::to('/unpublish-farme/'.$farme->id)); ?>" class="btn pmd-btn-fab pmd-btn-flat pmd-ripple-effect btn-default btn-sm">
                                    <i class="material-icons md-dark pmd-sm">thumb_down</i>
                                </a>

                                <?php endif; ?>
                            <?php endif; ?>
                            <button  data-target="#form-dialog-update-farme" data-id="<?php echo e($farme->id); ?>" data-toggle="modal" class="btn pmd-btn-fab pmd-btn-flat pmd-ripple-effect btn-default btn-sm" type="button">
                                <i class="material-icons md-dark pmd-sm">edit</i>
                            </button>
                            <a onclick="return confirm('Are You Sure !!!. \n You Want To Deleted This Product')" href="<?php echo e(URL::to('/delete-farme/'.$farme->id)); ?>" class="btn pmd-btn-fab pmd-btn-flat pmd-ripple-effect btn-default btn-sm">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <?php echo e(Form::open(['url'=> '/update-farme', 'method' => 'post', 'class' => 'form-horizontal', 'enctype' => 'multipart/form-data' ])); ?>
...
<div tabindex="-1" class="modal fade" id="form-dialog-sub" style="display: none;" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <?php echo e(Form::open(['url'=> '/save-farme', 'method' => 'post', 'class' => 'form-horizontal', 'enctype' => 'multipart/form-data' ])); ?>
...
<script>
    $(document).ready(function(){
        $("#form-dialog-update-farme").on("show.bs.modal", function(e) {
            ...
            $.ajax({
                url: "<?php echo e(url('/edit-farme')); ?>/" + id,
                data: {id: id},
