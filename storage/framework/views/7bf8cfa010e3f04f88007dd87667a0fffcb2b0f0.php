<?php $__env->startSection('mainContent'); ?>
    <div id="content" class="pmd-content inner-page">
        ...
        <div class="container-fluid full-width-container value-added-detail-page">
            <section class="row component-section">
                ...
                <div class="col-md-9">
                    <div class="component-box">
                        <!--Form dialog example -->
                        <?php echo $__env->make('backEnd.includes.product.product_modal', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                    </div>
           ...
           <div style="text-align: center" class="alert alert-success"><b><?php echo e(Session::get('message')); ?></b></div>
            ...
            <?php } ?>
            <?php echo e(Form::open(['url'=> '/search-back-product', 'method' => 'post', 'class' => 'header_search_form clearfix' ])); ?>
                ...
                <table class="table table-mc-red pmd-table">
                    ...
                    <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <?php if($product->id == $product_image->product_id): ?>
                                <td  style="text-align: center" data-title="Total">
                                    <img style="height: 60px; width: 60px"  src="<?php echo e(asset($product_image->small_image)); ?>" >
                                </td>
                                <?php break; ?>
                            <?php endif; ?>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            <td  style="text-align: center" data-title="Total"><?php echo e(str_limit($product->product_name_eng, 40)); ?></td>
                            <td  style="text-align: center"data-title="Status"><span class="status-btn blue-bg"><?php echo e($product->product_qty); ?></span></td>
                            <td id="status"  style="text-align: center"data-title="Status">
                                <span class="status-btn blue-bg"><?php echo e($product->product_price_eng); ?></span></td><td  style="text-align: center"data-title="Status"><span class="status-btn blue-bg"><?php echo e($product->status == 1 ? 'publishe' : 'unpublished'); ?></span>
                            </td>
                            <td style="text-align: center; width: auto" class="pmd-table-row-action">
                                <?php if(Session::get('admin_role') == 2): ?>
                                <?php if ($product->status == 2) { ?>
                                <a href="<?php echo e(URL::to('/publish-product/'.$product->id)); ?>" class="btn pmd-btn-fab pmd-btn-flat pmd-ripple-effect btn-default btn-sm">
                                    <i class="material-icons md-dark pmd-sm">thumb_up</i>
                                </a>
                                <?php }else{ ?>
                                <a href="<?php echo e(URL::to('/unpublish-product/'.$product->id)); ?>" class="btn pmd-btn-fab pmd-btn-flat pmd-ripple-effect btn-default btn-sm">
                                    <i class="material-icons md-dark pmd-sm">thumb_down</i>
                                </a>
                                <?php } ?>
                                <?php endif; ?>
                                <a href="<?php echo e(URL::to('/view-product/'.$product->id)); ?>" class="btn pmd-btn-fab pmd-btn-flat pmd-ripple-effect btn-default btn-sm">
                                    <i  class="material-icons md-dark pmd-sm">search</i>
                                </a>
                                <button  data-target="#form-dialog-update-product<?php echo e($product->id); ?>" data-toggle="modal" class="btn pmd-btn-fab pmd-btn-flat pmd-ripple-effect btn-default btn-sm" type="button"> <i class="material-icons md-dark pmd-sm">edit</i></button>
                                <a onclick="return confirm('Are You Sure !!!. \n You Want To Deleted This Product')" href="<?php echo e(URL::to('/delete-product-by-id/'.$product->id)); ?>" class="btn pmd-btn-fab pmd-btn-flat pmd-ripple-effect btn-default btn-sm">
                                    <i class="material-icons md-dark pmd-sm">delete</i>
                                </a>
                            </td>
                        </tr>
                        <?php echo $__env->make('backEnd.includes.product.product_modal_update', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    ...
    <script>
        function updateProduct(id) {
            ...
            $.ajax({
                type:'get',
                url: '<?php echo route('/update-view-product'); ?>',
                datatype: 'html',
                data:{'id':id},
        ...
        $(document).on('change','#product_cat', function () {
            ...
            $.ajax({
                type:'get',
                url: '<?php echo route('/manage-categories'); ?>',
                datatype: 'html',
                data:{'id':cat_id},
                success:function (data) {
