            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <?php echo e(Form::open(['url'=> '/update-memberCart', 'method' => 'post', 'class' => 'form-horizontal' ])); ?>
                                ...
                                <div class="col-md-12">
                                    <div class="pmd-card pmd-z-depth pmd-card-custom-form">
                                        <div class="pmd-card-body">
                                            ...
                                            <?php if($errors->has('member_cart_name')): ?>
                                            <span class="invalid-feedback" role="alert">
                                        <strong style="color: red"><?php echo e($errors->first('member_cart_name')); ?></strong>
                                    </span>
                                            <?php endif; ?>
                                            <div class="form-group">
                                            ...
                                            <?php if($errors->has('member_cart_number')): ?>
                                                <span class="invalid-feedback" role="alert">
                                        <strong style="color: red"><?php echo e($errors->first('member_cart_number')); ?></strong>
                                    </span>
                                            <?php endif; ?>
                                            <div class="form-group">
                                            ...
                                            <?php if($errors->has('member_cart_discount')): ?>
                                                <span class="invalid-feedback" role="alert">
                                        <strong style="color: red"><?php echo e($errors->first('member_cart_discount')); ?></strong>
                                    </span>
                                            <?php endif; ?>
