...
<div class="container" style="border: 2px solid rgba(0,1,1,0.34);">
    <div class="row">
        ...
        <div class="col-sm-6">
            ...
            <hr/>
            <p>Hi Dear <strong><?php echo e(Session::get('customer_name')); ?> Sir </strong>  Fill Up Your Shipping Information. If your Billing & Shipping Information are Same Just Click The  <strong>  Confirm & Next</strong></p>
            <br/>
            <?php echo e(Form::open(['url'=> '/customer-shipping-save', 'method' => 'post', 'class' => 'form-horizontal' ])); ?>

            <?php echo csrf_field(); ?>
            <div class="form-group">
                <input type="text" style="height: 45px;" name="ship_customer_name"  value="<?php echo e($customer->customer_name); ?>"  class="form-control" placeholder="Enter your name" required="required" data-error="Name is required.">

            </div>
            <div class="form-group">
                <input type="number" style="height: 45px;" name="ship_customer_phone_number" value="<?php echo e($customer->customer_phone_number); ?>"  class="form-control" placeholder="Enter your phone number " required="required" data-error="Name is required.">
            </div>
            <div class="form-group">
                <input type="email" style="height: 45px;" name="ship_customer_email" value="<?php echo e($customer->customer_email); ?>"  class="form-control" placeholder="Enter your email" required="required" data-error="Name is required.">
            </div>
            <div class="form-group">
            ...
            <br/>
            <div class="form-group">
                <textarea class="form-control" name="ship_customer_address"  required="required" placeholder="Enter your Full Address"  data-error="Address is required." ><?php echo e($customer->customer_address); ?></textarea>
            </div>
            <div class="form-group">
        ...
        <div class="col-sm-3 alert alert-heading">
            ...
            <br/>
            <br/>
            <div class="cart_count" style="float: right; font-size: 20px;"><i style="color: deepskyblue;" class="glyphicon glyphicon-shopping-cart"> <b>Cart :</b> <span style="color: #0a7e07; font-weight: bold;"><?php echo e(Cart::getTotalQuantity()); ?></span></i><br/>
