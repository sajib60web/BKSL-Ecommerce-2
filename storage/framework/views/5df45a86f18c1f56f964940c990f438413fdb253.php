            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <?php echo e(Form::open(['url'=> '/updateCustomer', 'name' => 'editeSubCat', 'method' => 'POST', 'class' => 'form-horizontal' ])); ?>
                                        ...
                                        <div class="pmd-card-body">
                                            ...
                                            <?php if($errors->has('customer_name')): ?>
                                                <span class="invalid-feedback" role="alert">
                                                    <strong style="color: red"><?php echo e($errors->first('customer_name')); ?></strong>
                                                </span>
                                            <?php endif; ?>
                                            ...
                                            <?php if($errors->has('customer_phone_number')): ?>
                                                <span class="invalid-feedback" role="alert">
                                        <strong style="color: red"><?php echo e($errors->first('customer_phone_number')); ?></strong>
                                    </span>
                                            <?php endif; ?>
                                            <div class="form-group">
                                            ...
                                            <?php if($errors->has('customer_email')): ?>
                                                <span class="invalid-feedback" role="alert">
                                        <strong style="color: red"><?php echo e($errors->first('customer_email')); ?></strong>
                                    </span>
                                            <?php endif; ?>
                                        <!-- Textarea -->
                                            ...
                                            <?php if($errors->has('customer_address')): ?>
                                                <span class="invalid-feedback" role="alert">
                                                    <strong style="color: red"><?php echo e($errors->first('customer_address')); ?></strong>
                                                </span>
                                            <?php endif; ?>
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" id="customer_member_id" name="member_cart_id">
                                                    ...
                                                    <?php $__currentLoopData = $memberCart; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $memberCart): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($memberCart->id); ?>"><?php echo e($memberCart->member_cart_name); ?></option>
                                                        <option value="0">-None-</option>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                </select>
                                            </div>
                                            <?php if($errors->has('member_cart_id')): ?>
                                                <span class="invalid-feedback" role="alert">
