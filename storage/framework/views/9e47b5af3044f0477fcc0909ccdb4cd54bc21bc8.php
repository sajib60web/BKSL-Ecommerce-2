                        ...
                        <div class="mb-5 p-4 bg-white shadow-sm">
                            <div id="stepper1" class="bs-stepper">
                                ...
                                <div class="bs-stepper-content">
                                    ...
                                    <form id="form-data" action="<?php echo e(route('/save-fb-cover')); ?>" method="post" class="tab-content" enctype="multipart/form-data">
                                        <?php echo csrf_field(); ?>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-4 choiceTop">
                                                        <div class="card" style="width: 18rem; border: 1px solid #4bdc4b; text-align: center;">
                                                            <a href="#">
                                                                <img class="card-img-top"  id="image_<?php echo e($farme->id); ?>" src="<?php echo e(asset($farme->farme_image)); ?>" style="width: 100%; height: 200px; padding: 5px;" alt="farme Image">
                                                            </a>
                                                        </div>
                                                        <div class="choiceFarm">
                                                            <input type="checkbox" onchange="imageControl(<?php echo e($farme->id); ?>)" name="farme_id" value="<?php echo e($farme->id); ?>">
                                                        </div>
                                                    </div>
                                        ...
                                        <div id="test-l-2" role="tabpanel" class="tab-pane" aria-labelledby="stepper1trigger2">
                                            <div class="form-group row">
                                                <div class="col-sm-8 col-sm-offset-2">
                                                    <div class="warper">
                                                        <div style="width: 622px; background: url('<?php echo e(asset('backEnd/stepper')); ?>/img/grande.jpg')no-repeat;">
