...
<div class="logincard">
    <div class="pmd-card card-default pmd-z-depth">
        ...
        <div class="login-card">
            ...
            <?php echo e(Form::open(['url'=> '/login-admin', 'method' => 'post', 'class' => 'form-horizontal' ])); ?>

                <div class="pmd-card-title card-header-border text-center">
                    <div class="loginlogo">
                        <a href="javascript:void(0);"><img src="<?php echo e(asset('backEnd/themes/')); ?>/images/logo-icon.png" alt="Logo"></a>
                    </div>
