    ...
    <div class="col-sm-12">
        <div class="row">
            ...
            <div class="col-sm-6" style="border: 0px solid #000000;">
                <h2><b>Register</b></h2>
                <br/>
                <?php echo e(Form::open(['url'=> '/billing-page', 'method' => 'post', 'class' => 'form-horizontal' ])); ?>
                ...
                <h2><b>Login</b></h2>
                <br/>
                <p class="alert alert-heading"><?php echo Session::get('message'); ?></p>
                <?php echo e(Form::open(['url'=> '/affiliate-login', 'method' => 'post', 'class' => 'form-horizontal' ])); ?>
                ...
                <div class="form-group">
                    <a href="<?php echo e(URL::to('/login/facebook')); ?>"><button style="background-color: #4267b2; color: #ffffff; height: 40px;" class="form-control btn btn-block"></span>Continue with Facebook</button></a>
                </div>
            </div>
