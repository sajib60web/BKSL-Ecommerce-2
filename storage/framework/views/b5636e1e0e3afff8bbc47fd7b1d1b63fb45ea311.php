            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <?php echo e(Form::open(['url'=> '/update-expense', 'method' => 'post', 'class' => 'form-horizontal' ])); ?>
                                ...
                                <div class="col-md-12">
                                    <div class="pmd-card pmd-z-depth pmd-card-custom-form">
                                        <div class="pmd-card-body">
                                            ...
                                            <?php if($errors->has('expense_name')): ?>
                                                <span class="invalid-feedback" role="alert">
                                        <strong style="color: red"><?php echo e($errors->first('expense_name')); ?></strong>
                                    </span>
                                            <?php endif; ?>
                                            <div class="form-group">
                                            ...
                                            <?php if($errors->has('expense_amount')): ?>
                                                <span class="invalid-feedback" role="alert">
                                        <strong style="color: red"><?php echo e($errors->first('expense_amount')); ?></strong>
                                    </span>
                                            <?php endif; ?>
                                        <!-- Textarea -->
                                            ...
                                            <?php if($errors->has('expense_description')): ?>
                                                <span class="invalid-feedback" role="alert">
                                        <strong style="color: red"><?php echo e($errors->first('expense_description')); ?></strong>
                                    </span>
                                            <?php endif; ?>
                                            <div class="form-group">
