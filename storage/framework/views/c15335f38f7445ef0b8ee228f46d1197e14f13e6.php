            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <?php echo e(Form::open(['url'=> '/update-extraIncome', 'method' => 'post', 'class' => 'form-horizontal' ])); ?>
                                ...
                                <div class="col-md-12">
                                    <div class="pmd-card pmd-z-depth pmd-card-custom-form">
                                        <div class="pmd-card-body">
                                            ...
                                            <?php if($errors->has('income_name')): ?>
                                                <span class="invalid-feedback" role="alert">
                                        <strong style="color: red"><?php echo e($errors->first('income_name')); ?></strong>
                                    </span>
                                            <?php endif; ?>
                                            <div class="form-group">
                                            ...
                                            <?php if($errors->has('income_amount')): ?>
                                                <span class="invalid-feedback" role="alert">
                                        <strong style="color: red"><?php echo e($errors->first('income_amount')); ?></strong>
                                    </span>
                                            <?php endif; ?>
                                        <!-- Textarea -->
                                            ...
                                            <?php if($errors->has('income_description')): ?>
                                                <span class="invalid-feedback" role="alert">
                                        <strong style="color: red"><?php echo e($errors->first('income_description')); ?></strong>
                                    </span>
                                            <?php endif; ?>
                                            <div class="form-group">
